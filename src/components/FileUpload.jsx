...
const authenticator = async () => {
    try {
        const response = await fetch("https://university-library.vercel.app/api/auth"); // for development http://localhost:3000/api/auth and for production https://university-library.vercel.app/api/auth

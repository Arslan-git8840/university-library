    ...
    <div className='text-slate-200 p-4 rounded-lg shadow-lg flex flex-col lg:flex-row w-full'>
      ...
      <div className='lg:p-12 pt-16 lg:mr-8 mr-0 lg:w-2/3 order-2 lg:order-1 w-full '>
        ...
        <div className='flex sm:gap-4 gap-2 mb-2 flex-col sm:flex-row'>
          <p className='flex items-center whitespace-nowrap'><span className='font-semibold text-primary-gold'>By</span>  {book.author}</p>
          <p className='flex items-center whitespace-nowrap'><span className='font-semibold text-primary-gold'>Genre</span>  {book.genre}</p>
          <p className='flex items-center whitespace-nowrap'><span className='font-semibold text-primary-gold'>Rating</span> 
            <span className='flex items-center ml-1'>
              {/* Render star icons based on rating */}
              {[...Array(Math.round(book.rating))].map((_, index) => (
        ...
        <div className='flex gap-4 mb-2'>
          <p className='flex items-center'><span className='font-semibold text-primary-gold'>Total books</span>  <span>{book.totalCopies}</span></p>
          <p className='flex items-center'><span className='font-semibold text-primary-gold'>Available books</span>   <span>{book.availableCopies}</span></p>
        </div>
